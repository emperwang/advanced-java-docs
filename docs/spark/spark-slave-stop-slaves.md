...
```shell
[root@name2 sbin]# sh -x stop-slaves.sh + '[' -z '' ']'
+++ dirname stop-slaves.sh++ cd ./..
++ pwd+ export SPARK_HOME=/mnt/spark-alone/spark-2.4.6-bin-hadoop2.6
...
+ /mnt/spark-alone/spark-2.4.6-bin-hadoop2.6/sbin/slaves.sh cd /mnt/spark-alone/spark-2.4.6-bin-hadoop2.6 ';' /mnt/spark-alone/spark-2.4.6-bin-hadoop2.6/sbin/stop-slave.sh
name3: stopping org.apache.spark.deploy.worker.Worker
name2: stopping org.apache.spark.deploy.worker.Worker
name4: stopping org.apache.spark.deploy.worker.Worker
