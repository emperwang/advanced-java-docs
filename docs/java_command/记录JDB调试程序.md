...
![](../image/jdb/way1-breakpoint.png)

5.执行一步

![](../image/jdb/way1-step.png)

6.查看变量

![](../image/jdb/way1-locals.png)

7.查看执行到哪里

![](../image/jdb/way1-list.png)

8.执行到结束

![](../image/jdb/way1-continue.png)
...
![](../image/jdb/way2-start.png)

连接到运行中的程序，此时端口要和脚本中的端口号一致。

![](../image/jdb/way2-into.png)
